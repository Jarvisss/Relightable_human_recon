...
from utils.geo_utils import index, orthogonal, perspective, unproject_orthogonal,perspective_opencv
...
class BasePIFuNet(nn.Module):
    def __init__(self,
        ...
        self.index = index
        self.projection = orthogonal if projection_mode == 'orthogonal' else perspective if projection_mode=='perspective' else perspective_opencv
        self.unprojection = unproject_orthogonal
        self.preds = None
        self.labels = None
