'''
https://github.com/AliaksandrSiarohin/cuda-gridsample-grad2#cuda-based-grid-sample-implimentation-with-second-order-derivative-support
'''
...
gridsample_grad2 = load(name='gridsample_grad2', sources=['utils/gridsample_cuda.cpp', 'utils/gridsample_cuda.cu'], verbose=True)
...
class _GridSample2dBackward(torch.autograd.Function):
    ...
    def forward(ctx, grad_output, input, grid, padding_mode=0, align_corners=True):
        ...
        ## fix torch version, by change [op] to [op, _]
